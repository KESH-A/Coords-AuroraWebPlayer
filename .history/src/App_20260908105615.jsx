    ...
    >
      ...
      {currentTrack && (
        <div
          ...
          className={`fixed bottom-4 left-1/2 -translate-x-1/2 w-[92%] max-w-lg p-3 rounded-3xl border border-white/25 z-40 shadow-2xl flex items-center justify-between gap-3 cursor-pointer active:scale-[0.99] transition-all backdrop-blur-lg bg-slate-900/50 ${surfaceClass}`}
        >
