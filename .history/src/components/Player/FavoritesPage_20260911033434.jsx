...
export const FavoritesPage = ({ tracks = [], onClose }) => {
  ...
  // Glass teması kontrolleri
  const isGlass = themeStyle === 'glass' || themeStyle === 'glass-surface' || true; // Cam efekti zorlama

  // Birebir mobildeki buzlu/sıvı arka plan stili
  const modalGlassStyle = isGlass ? {
  ...
  // Kartların etrafındaki o yumuşak mavi/mor halkalı cam stili
  const itemGlassStyle = (playing) => {
    if (playing) {
      return {
        ...
        boxShadow: '0 0 25px rgba(168, 85, 247, 0.4), inset 0 1px 2px rgba(255, 255, 255, 0.4)',
      };
    }
    return isGlass ? {
      ...
      boxShadow: '0 10px 30px rgba(0, 0, 0, 0.25), inset 0 1px 1px rgba(255, 255, 255, 0.2)',
    } : {
  ...
  return (
    <div 
      ...
      style={{ ...modalGlassStyle, color: textColor || '#ffffff' }}
    >
      {/* Header */}
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar px-4 pb-28 max-w-md mx-auto w-full relative">
        {favTracks.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-slate-400 gap-3 relative z-10">
            ...
            >
              <Heart className="w-12 h-12 opacity-80" style={{ color: activeColor }} />
            </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-3.5 truncate">
                    <div 
                      className="w-12 h-12 rounded-2xl overflow-hidden shrink-0 shadow-lg"
                  ...
                  <div className="flex items-center gap-2.5 shrink-0">
                    ...
                    <div
                      ...
                      style={{ 
                        ...
                        boxShadow: playing ? `0 0 20px ${activeColor}` : 'none'
                      }}
                    >
                      {playing ? (
