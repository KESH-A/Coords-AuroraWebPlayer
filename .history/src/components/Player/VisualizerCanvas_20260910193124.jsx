...
export const VisualizerCanvas = () => {
  ...
  useEffect(() => {
    ...
    // DÜZELTİLMİŞ RETRO / VHS MODU
    const drawVHS = (w, h) => {
      ctx.clearRect(0, 0, w, h);

      // İnce Tarama Çizgileri
      ...
      for (let i = 0; i < barCount; i++) {
        const val = mirrored[i];
        if (val < 5) continue; // Ses yoksa ölü barı çizme
        ...
        // Ritim Vurduğunda Barın Üstünde Sıçrayan Parlak Neon Çizgi
        if (val > 60) {
