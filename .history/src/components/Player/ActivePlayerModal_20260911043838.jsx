  ...
  const onTouchMove = (e) => {
    ...
    if (touchType.current === 'swipe') {
      ...
      if (isRight) {
        ...
        setVolume(newVol / 100); // Anlık ses güncellemesi
      } else {
        ...
        setBrightness(newBright); // Anlık parlaklık güncellemesi
      }
    }
  };
      ...
      <div className="flex items-center justify-between w-full max-w-md mx-auto">
        ...
        <div className="flex items-center gap-2">
          <button 
            ...
            style={{ color: visualizer ? activeColor : '#94a3b8' }}
          >
      ...
      <div className="flex-1 flex flex-col items-center justify-center my-4 max-w-md w-full mx-auto">
        {showEQ ? (
          ...
          <div className="w-full flex flex-col items-center gap-5">
            ...
            <div className={`w-full overflow-hidden transition-all duration-300 ${visualizer ? 'max-h-20 opacity-100 mt-2' : 'max-h-0 opacity-0'}`}>
