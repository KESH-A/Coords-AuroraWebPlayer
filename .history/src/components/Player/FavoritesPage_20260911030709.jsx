...
export const FavoritesPage = ({ tracks = [], onClose }) => {
  ...
  return (
    <div 
      ...
      style={{
        // Arka planı şeffaflaştırıp gerçek buzlu cam blurring sağlayan stil
        background: isGlass ? 'rgba(15, 23, 42, 0.45)' : '#070913',
                  ...
                  <div className="flex items-center gap-2.5 shrink-0">
                    ...
                    <div
                      ...
                      style={{ 
                        ...
                        boxShadow: playing ? `0 0 15px ${activeColor}` : undefined
                      }}
                    >
                      {playing ? (
