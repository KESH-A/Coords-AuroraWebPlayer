...
export const FavoritesPage = ({ tracks = [], onClose }) => {
  ...
  return (
    <div 
      ...
      style={{
        background: isGlass ? 'rgba(15, 23, 42, 0.75)' : '#070913',
          ...
          {favTracks.length > 0 && (
            <>
              <button 
                ...
                className="text-[11px] font-bold px-3 py-1 rounded-full transition-all border border-white/20"
                style={{ 
            ...
            {favTracks.map((track, index) => {
              ...
              return (
                <div
                  ...
                  className="flex items-center justify-between p-3.5 rounded-[28px] cursor-grab active:cursor-grabbing transition-all duration-200 active:scale-[0.98]"
                  style={{
                    background: playing 
