...
export const ActivePlayerModal = ({ isOpen, onClose, tracks = [] }) => {
  ...
  return (
    <div
      ref={modalRef}
      className={modalThemeClass + ' w-full fixed inset-0 z-[200] overflow-hidden rounded-none! bg-[#070913]/90 backdrop-blur-3xl flex flex-col justify-between p-6 select-none ' + animationClass}
