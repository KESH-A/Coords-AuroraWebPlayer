...
export const FavoritesPage = ({ tracks = [], onClose }) => {
  ...
  return (
    <div 
      /* animate-slide-up ile aşağıdan yukarı kayarak gelir */
      className="fixed inset-0 z-[250] overflow-hidden flex flex-col animate-slide-up select-none"
      style={{
        /* Çok hafif koyuluk + yüksek Blur ile arkadaki her şeyi gösteren cam katmanı */
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 pt-6 max-w-md mx-auto w-full z-20 shrink-0">
        <div className="flex items-center gap-3">
          <button
            onClick={onClose}
            className="w-10 h-10 rounded-full flex items-center justify-center active:scale-95 transition-all bg-white/10 border border-white/20 backdrop-blur-md"
          >
          ...
          {favTracks.length > 0 && (
            <>
              <button 
                ...
                className="text-[11px] font-bold px-3 py-1 rounded-full transition-all border border-white/20 backdrop-blur-md"
                style={{ 
            ...
            {favTracks.map((track, index) => {
              ...
              return (
                <div
                  ...
                  className="flex items-center justify-between p-3.5 rounded-[28px] cursor-grab active:cursor-grabbing transition-all duration-200 active:scale-[0.98] bg-white/10 border border-white/15 backdrop-blur-md shadow-lg"
                  style={playing ? {
                ...
                >
                  ...
                  <div className="flex items-center gap-2.5 shrink-0">
                    ...
                    <div
                      ...
                      className="w-10 h-10 rounded-full flex items-center justify-center transition-all cursor-pointer shadow-lg active:scale-95 bg-white/10 border border-white/20"
                      style={{ 
                        backgroundColor: playing ? activeColor : undefined, 
                        borderColor: playing ? activeColor : undefined,
