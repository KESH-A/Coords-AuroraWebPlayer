...
export const FavoritesPage = ({ tracks = [], onClose }) => {
  ...
  // Glass teması seçiliyse uygulanacak ultra-blur sıvı cam stilleri
  const isGlass = themeStyle === 'glass';

  const modalGlassStyle = isGlass ? {
    background: 'radial-gradient(circle at 50% 0%, rgba(30, 58, 138, 0.4) 0%, rgba(10, 15, 30, 0.75) 100%)',
  ...
  const itemGlassStyle = (playing) => {
    if (playing) {
      return {
        background: 'linear-gradient(135deg, rgba(168, 85, 247, 0.35) 0%, rgba(88, 28, 135, 0.45) 100%)',
        backdropFilter: 'blur(20px)',
        WebkitBackdropFilter: 'blur(20px)',
        border: '1px solid rgba(216, 180, 254, 0.4)',
        boxShadow: '0 0 30px rgba(168, 85, 247, 0.4), inset 0 1px 1px rgba(255, 255, 255, 0.3)',
      };
    }
    return isGlass ? {
