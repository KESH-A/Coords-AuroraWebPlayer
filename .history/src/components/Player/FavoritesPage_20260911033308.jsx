...
export const FavoritesPage = ({ tracks = [], onClose }) => {
  ...
  const isGlass = themeStyle === 'glass' || themeStyle === 'glass-surface';

  // DÜZELTME: Opak gradyan yerine şeffaf cam katmanı + yüksek blur
  ...
  const itemGlassStyle = (playing) => {
    if (playing) {
      return {
        ...
        boxShadow: '0 0 25px rgba(168, 85, 247, 0.35), inset 0 1px 1px rgba(255, 255, 255, 0.4)',
      };
    }
    return isGlass ? {
