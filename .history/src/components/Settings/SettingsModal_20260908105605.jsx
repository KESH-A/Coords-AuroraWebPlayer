...
import { X, Sliders, Eye, Sparkles, Palette, FolderPlus, Pipette, Type } from 'lucide-react';
...
export const SettingsModal = ({ isOpen, onClose, onFolderSelect, isLoading }) => {
  ...
  const containerStyle = themeStyle === 'glass'
    ...
    : 'glass bg-[#0d111d]/90 border-white/10 shadow-none';
    ...
    <>
      ...
      {isLoading && (
        <div className="fixed inset-0 z-[400] flex items-center justify-center glass-overlay">
          <div className="glass p-8 rounded-3xl glass-modal flex flex-col items-center gap-4 shadow-2xl">
