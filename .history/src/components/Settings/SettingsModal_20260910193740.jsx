...
import { X, Sliders, Sparkles, Palette, Pipette, FolderPlus, Type, Smartphone, Zap, Activity, PaintBucket, Layers, BarChart3, Circle, Waves } from 'lucide-react';
    ...
    >
      ...
      >
        ...
        <div className="space-y-6 overflow-y-auto pt-4 pr-1 no-scrollbar flex-1">
          ...
          {/* Accent Color (Özel Renk Seçici Eklendi) */}
          <div className="space-y-3">
            <label className="text-xs font-semibold text-slate-400 flex items-center gap-1.5">
          ...
          {/* Visualizer Style (Retro Butonu Kaldırıldı) */}
          ...
          {/* Visualizer Color (Özel Renk Seçici Eklendi) */}
          <div className="p-4 rounded-2xl bg-white/5 border border-white/10 space-y-3">
            <label className="text-xs font-semibold text-slate-400 flex items-center gap-1.5">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              {/* Visualizer Özel Renk Seçici (Pipette) */}
              <label 
